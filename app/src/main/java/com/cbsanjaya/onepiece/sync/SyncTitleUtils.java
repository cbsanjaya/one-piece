...
public class SyncTitleUtils {
    ...
    private static final String CONTENT_AUTHORITY = TitleContract.CONTENT_AUTHORITY;
    private static final String PREF_SETUP_COMPLETE = "setup_complete";
    // Value below must match the account type specified in res/xml/syncadapter.xml
    public static final String ACCOUNT_TYPE = "com.cbsanjaya.onepiece.account";
    ...
    public static void TriggerRefresh() {
        ...
        ContentResolver.requestSync(
                ...
                TitleContract.CONTENT_AUTHORITY,                 // Content authority
                b);                                             // Extras
    }
}
